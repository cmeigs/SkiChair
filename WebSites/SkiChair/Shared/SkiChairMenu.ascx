<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SkiChairMenu.ascx.cs" Inherits="SkiChair.Merchandise.Views.SkiChairMenu" %>
        ...
        <ul id="primary" class="dropdown dropdown-horizontal">
            ...
            <li><asp:LinkButton ID="LinkButton29" PostBackUrl="~/Merchandise/ProductMenu.aspx?pid=15" runat="server">Products</asp:LinkButton>
                <ul>
                    ...
                    <li><asp:LinkButton ID="LinkButton38" PostBackUrl="~/Merchandise/ProductMenu.aspx?pid=27" runat="server">Sports Bottle Openers</asp:LinkButton></li>
                    <li><asp:LinkButton ID="LinkButton39" PostBackUrl="~/Merchandise/ProductMenu.aspx?pid=28" runat="server">Hockey Accessories</asp:LinkButton></li>
                </ul>
            </li>
